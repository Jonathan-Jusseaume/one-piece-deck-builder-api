...
public class CardController {
    ...
    @Operation(
        summary = "Get a page of the card list matching different criteria"
    )
    @GetMapping
    public PagingResultWithFilters<Card, CardSearch> list(
        ...
        @RequestParam(required = false, name = "type") @Parameter(
            name = "type",
