...
@NoArgsConstructor
@Schema(
    description = "Represents a card with various attributes such as type, colors, tags, and effects."
)
public class Card {
    ...
    @Schema(
        description = "List of colors associated with the card",
        example = "[\"RED\", \"BLUE\"]"
    )
    ...
    @Schema(
        description = "The attribute of the card, representing its main strength",
        example = "STRIKE"
    )
    ...
    @Schema(
        description = "Effect or description of the card's ability",
        nullable = true
    )
    ...
    @Schema(
        description = "Counter for the card",
        example = "1000",
        nullable = true
    )
