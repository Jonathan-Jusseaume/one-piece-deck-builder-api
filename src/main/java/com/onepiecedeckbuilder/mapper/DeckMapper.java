...
@Mapper(componentModel = MappingConstants.ComponentModel.SPRING, uses = {CardMapper.class, DateMapper.class})
public interface DeckMapper {

    @Mapping(target = "creationDate", qualifiedByName = "instantToLocalDate")
    @Mapping(target = "favorite", source = ".", qualifiedByName = "fillFavoriteAccordingToConnectedUser")
    ...
    @AfterMapping
    default void hideCardsWhenMinimizeData(@MappingTarget Deck deck, @Context CustomMapperContext context) {
