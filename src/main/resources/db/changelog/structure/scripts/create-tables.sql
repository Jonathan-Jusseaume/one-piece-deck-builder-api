...
CREATE TABLE IF NOT EXISTS UT_ATTRIBUTE_DESCRIPTION
(
...
CREATE TABLE IF NOT EXISTS UT_RARITY
(
    ID    INTEGER,
    LABEL VARCHAR(30),
...
CREATE TABLE IF NOT EXISTS UT_TYPE
(
    ID INTEGER,
    CONSTRAINT PK_TYPE PRIMARY KEY (ID)
);

CREATE TABLE IF NOT EXISTS UT_TYPE_DESCRIPTION
(
    TYPE_ID       INTEGER,
    LANGUAGE_CODE VARCHAR(5),
    NAME          VARCHAR(30) NOT NULL,
...
CREATE TABLE IF NOT EXISTS UT_TAG
(
    ID INTEGER,
    CONSTRAINT PK_TAG PRIMARY KEY (ID)
);

CREATE TABLE IF NOT EXISTS UT_TAG_DESCRIPTION
(
    TAG_ID        INTEGER,
    LANGUAGE_CODE VARCHAR(5),
...
CREATE TABLE IF NOT EXISTS UT_PRODUCT
(
    ID           VARCHAR(50),
    RELEASE_DATE DATE,
...
CREATE TABLE IF NOT EXISTS UT_PRODUCT_DESCRIPTION
(
...
CREATE TABLE IF NOT EXISTS UT_CARD_DESCRIPTION
(
    CARD_ID       VARCHAR(50),
    LANGUAGE_CODE VARCHAR(5),
    NAME          VARCHAR(100),
...
CREATE TABLE IF NOT EXISTS UT_CARD_IMAGE
(
    ID         SERIAL,
    CARD_ID    VARCHAR(50),
    RARITY_ID  INTEGER,
...
CREATE TABLE IF NOT EXISTS UT_CARD_COLOR
(
    COLOR_ID INTEGER,
    CARD_ID  VARCHAR(50),
...
CREATE TABLE IF NOT EXISTS UT_CARD_TAG
(
    TAG_ID  INTEGER,
    CARD_ID VARCHAR(50),
...
CREATE TABLE IF NOT EXISTS UT_DECK
(
    ID              UUID,
    USER_MAIL       TEXT,
...
CREATE TABLE IF NOT EXISTS UT_DECK_CARD
(
    ID      SERIAL,
    DECK_ID UUID,
    CARD_ID VARCHAR(50),
...
CREATE TABLE IF NOT EXISTS UT_DECK_FAVORITE
(
    ID        SERIAL,
    DECK_ID   UUID,
    USER_MAIL TEXT,
    CONSTRAINT PK_DECK_FAVORITE PRIMARY KEY (ID),
    CONSTRAINT FK_DECK_ID FOREIGN KEY (DECK_ID) REFERENCES UT_DECK (ID),
    CONSTRAINT FK_USER_MAIL FOREIGN KEY (USER_MAIL) REFERENCES UT_USER (MAIL)
);
