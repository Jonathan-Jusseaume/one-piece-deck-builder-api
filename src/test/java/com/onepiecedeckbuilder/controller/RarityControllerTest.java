...
class RarityControllerTest {
    ...
    void shouldReturnAllRaritiesInTheSpecifiedOrder() throws Exception {
        MvcResult mvcResult = this.mockMvc.perform(
                get("/rarities").accept(MediaType.APPLICATION_JSON)
            )
        ...
        TypeReference<List<Rarity>> rarityListTypeReference =
            new TypeReference<>() {};
        List<Rarity> actual = objectMapper.readValue(
            jsonResponse,
            rarityListTypeReference
        );
