...
class TagControllerTest {
    ...
    @DisplayName(
        "Should return all tags for given language in the specified order"
    )
    void shouldReturnAllTagsInTheSpecifiedOrder(
        String languageCode,
        List<Tag> expected
    ) throws Exception {
        ...
        TypeReference<List<Tag>> tagListTypeReference =
            new TypeReference<>() {};
        List<Tag> actual = objectMapper.readValue(
            jsonResponse,
            tagListTypeReference
        );
        ...
        return Stream.of(
            ...
            Arguments.of(
                ...
                Arrays.asList(
                    ...
                    new Tag()
                        .setId(0L)
                        .setLabel("Equipage du chapeau de paille"),
                    new Tag().setId(4L).setLabel("Homme-poisson"),
                    new Tag()
                        .setId(7L)
                        .setLabel("L'Équipage des Moines Dépravés"),
