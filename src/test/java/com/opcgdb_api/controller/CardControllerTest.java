...
class CardControllerTest {
    ...
    private static Stream<Arguments> provideParametersAndExpectedResults() {
        return Stream.of(
                Arguments.of("page=0&size=10&power=6000&languageCode=en", List.of(new Card().setId("ST01-010"), new Card().setId("ST01-012"), new Card().setId("ST02-006"), new Card().setId("ST02-009"), new Card().setId("ST02-010"))),
                Arguments.of("page=0&size=10&typeId=0&colorId=0&languageCode=en", List.of(new Card().setId("ST01-001"))),
                Arguments.of("page=0&size=10&tagId=1&productId=ST-01&languageCode=en", List.of(new Card().setId("ST01-001"), new Card().setId("ST01-012"), new Card().setId("ST01-013"))),
                Arguments.of("page=0&size=10&rarityId=3&languageCode=en", List.of(new Card().setId("ST01-012"), new Card().setId("ST01-013"), new Card().setId("ST02-009"), new Card().setId("ST02-013")))
        );
    }
